...
- fix issue where transaction items without a TRANSACTION_CONFIRMED_EVENT have unhandled error when clicking into activity log ([#13221](https://github.com/MetaMask/metamask-extension/pull/13221))
- Remove bottom space when hiding testnet ([#12821](https://github.com/MetaMask/metamask-extension/pull/12821))
- mainnet tokens autopopulate add token form fields when on custom networks #12087 ([#12800](https://github.com/MetaMask/metamask-extension/pull/12800))
- Adjust the padding of lock button ([#13017](https://github.com/MetaMask/metamask-extension/pull/13017))
- Prevent automatic rejection of confirmations ([#13194](https://github.com/MetaMask/metamask-extension/pull/13194))
- Lock button active state fix ([#13100](https://github.com/MetaMask/metamask-extension/pull/13100))
- Add missing permissions middleware hook ([#13205](https://github.com/MetaMask/metamask-extension/pull/13205))
- Add more missing `appName` messages ([#13140](https://github.com/MetaMask/metamask-extension/pull/13140))
- Wire up priority fee range in new gas modal ([#13044](https://github.com/MetaMask/metamask-extension/pull/13044))
- Fix account name duplicates ([#12867](https://github.com/MetaMask/metamask-extension/pull/12867))
- Choose accounts refactor ([#13039](https://github.com/MetaMask/metamask-extension/pull/13039))
- Fix permissions-connect-footer "learn more" link ([#13092](https://github.com/MetaMask/metamask-extension/pull/13092))
- Subject metadata cleanup ([#13090](https://github.com/MetaMask/metamask-extension/pull/13090))
- Fix typo in German translation ([#13040](https://github.com/MetaMask/metamask-extension/pull/13040))
- Make restore vault a form so an user can submit via keyboard ([#12989](https://github.com/MetaMask/metamask-extension/pull/12989))
- Remove legacy node parent detection ([#12814](https://github.com/MetaMask/metamask-extension/pull/12814))
- Fix order of account list ([#12999](https://github.com/MetaMask/metamask-extension/pull/12999))
- Add crowdin configuration and github action ([#12552](https://github.com/MetaMask/metamask-extension/pull/12552))
- Wire up network stability slider in new gas modal ([#13029](https://github.com/MetaMask/metamask-extension/pull/13029))
- display hex data on send screen fixed ([#12709](https://github.com/MetaMask/metamask-extension/pull/12709))
- Support EIP-1559 on Trezor Model One ([#13023](https://github.com/MetaMask/metamask-extension/pull/13023))
- Add subject types ([#13026](https://github.com/MetaMask/metamask-extension/pull/13026))
- "eth_signTypedData" presents fields that do not appear in 'types' filed ([#12905](https://github.com/MetaMask/metamask-extension/pull/12905))
- toggle-button ([#12817](https://github.com/MetaMask/metamask-extension/pull/12817))
- Identicon size fix ([#13014](https://github.com/MetaMask/metamask-extension/pull/13014))
- Remove unnecessary action text property from whats new notification 9 ([#13021](https://github.com/MetaMask/metamask-extension/pull/13021))
- Dispose the trezor connect iframe upon lock ([#13018](https://github.com/MetaMask/metamask-extension/pull/13018))
- Fix tx-insight accreditation styling ([#13009](https://github.com/MetaMask/metamask-extension/pull/13009))
- Fix typo in conversion.utils.js ([#12998](https://github.com/MetaMask/metamask-extension/pull/12998))
- Add what's new notification for transaction insights ([#13000](https://github.com/MetaMask/metamask-extension/pull/13000))
- Consolidate permission exports ([#13012](https://github.com/MetaMask/metamask-extension/pull/13012))
- Fix browser specific manifest generation ([#13007](https://github.com/MetaMask/metamask-extension/pull/13007))
- Fix metamask-translation component for new Storybook format ([#12892](https://github.com/MetaMask/metamask-extension/pull/12892))
- Tx decoding accreditation ([#12918](https://github.com/MetaMask/metamask-extension/pull/12918))
- Update tx-insights url ([#12997](https://github.com/MetaMask/metamask-extension/pull/12997))
- Fix confirmed transaction time  ([#12633](https://github.com/MetaMask/metamask-extension/pull/12633))
- info-tooltip ([#12901](https://github.com/MetaMask/metamask-extension/pull/12901))
- Fix slider component to for new Storybook format ([#12897](https://github.com/MetaMask/metamask-extension/pull/12897))
- Fix radio-group component to for new Storybook format ([#12900](https://github.com/MetaMask/metamask-extension/pull/12900))
- Optimize rest of swaps flow ([#12939](https://github.com/MetaMask/metamask-extension/pull/12939))
- Add `yarn-deduplicate` step to README ([#13004](https://github.com/MetaMask/metamask-extension/pull/13004))
- Updating PulseLoader story format ([#12818](https://github.com/MetaMask/metamask-extension/pull/12818))
- Capitalize Activity log ([#13002](https://github.com/MetaMask/metamask-extension/pull/13002))
- Tx insights fixes ([#12988](https://github.com/MetaMask/metamask-extension/pull/12988))
- Swaps UI redesign for the View Quote page ([#12950](https://github.com/MetaMask/metamask-extension/pull/12950))
- Permission System 2.0 ([#12243](https://github.com/MetaMask/metamask-extension/pull/12243))
- Updating styles so they don't override fontawesome, removing duplicate addons ([#12971](https://github.com/MetaMask/metamask-extension/pull/12971))
- Fix unlock-page component for new Storybook format  ([#12894](https://github.com/MetaMask/metamask-extension/pull/12894))
- Clear the clipboard after seed phrase is pasted (Restore vault) ([#12987](https://github.com/MetaMask/metamask-extension/pull/12987))
- Fix: update URL for adding custom build on Firefox ([#12978](https://github.com/MetaMask/metamask-extension/pull/12978))
- Adding validations for advance gas fee input fields ([#12879](https://github.com/MetaMask/metamask-extension/pull/12879))
- Jestify app/scripts/lib/**/*.test.js ([#12890](https://github.com/MetaMask/metamask-extension/pull/12890))
- Using EIP-1559 V2 for approve transaction flow ([#12906](https://github.com/MetaMask/metamask-extension/pull/12906))
- Adding tooltips in edit gas fee network status section ([#12916](https://github.com/MetaMask/metamask-extension/pull/12916))
- fix gas-tooltip fonts ([#12968](https://github.com/MetaMask/metamask-extension/pull/12968))
- Implementing design feedbacks in EIP-1559 V2 flow ([#12943](https://github.com/MetaMask/metamask-extension/pull/12943))
- Disable `remote-redux-devtools` in non-dev builds ([#12956](https://github.com/MetaMask/metamask-extension/pull/12956))
- Update package.json + yarn.lock with contract-metadata version 1.31.0  ([#12947](https://github.com/MetaMask/metamask-extension/pull/12947))
- Remove redundant `EIP_1559_V2_ENABLED` comparison ([#12954](https://github.com/MetaMask/metamask-extension/pull/12954))
- Textarea UI component ([#12688](https://github.com/MetaMask/metamask-extension/pull/12688))
- Adding gas limit section on advance gas fee modal ([#12865](https://github.com/MetaMask/metamask-extension/pull/12865))
- Added SiteOrigin and PermissionList components ([#12832](https://github.com/MetaMask/metamask-extension/pull/12832))
- Latest update conversion date  - issue  #10741 ([#12422](https://github.com/MetaMask/metamask-extension/pull/12422))
